            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->administrador == 1 || Auth::user()->facilitador == 1)
                        ...
                        <x-nav-link :href="route('examenes-completador')" :active="request()->routeIs('examenes-completador')">
                            {{ __('Completados') }}
                        </x-nav-link>
                    @endif
                    @if (Auth::user()->administrador == 1)
                        <x-nav-link :href="route('panel_usuarios')" :active="request()->routeIs('panel_usuarios')">
                            {{ __('Usuarios') }}
                        </x-nav-link>
                    @endif
