<x-app-layout>
            ...
            <div class="overflow-hidden sm:rounded-lg">
                <div class="row">
                    <div class="col-12 mb-2">
                        <div class="header-pages rounded-top text-white">
                            <span class="text-uppercase">Editar Examen</span>
                        </div>
                    </div>
                    <div class="col-12 mb-2">
                    ...
                    <div v-if="CurrentTema.length > 0 && CurrentTema[0].preguntas.length > 0" class="col-12 mb-2">
                        <div class="text-right">
                            <div class="cancel_saving_button d-inline-block">
                                <button class="btn btn-success rounded-0 ml-2" @click="actuaizarExamen()"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <p v-if="tema_view == 'create'" class="modal-title mb-0 h6">{{ __('Agregar Tema') }}
                                </p>
                                ...
                                <section class="row">
                                    <aside class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input v-validate="'required'" type="text" v-model="tema.nombre"
                                                name="title" class="form-control single-input-form"
                                                placeholder="Coloca el nombre del tema...">
                                    ...
                                    <aside class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select v-validate="'required'" v-model="tema.tipo" name="type"
                ...
                <div class="modal fade" id="PreguntaModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <p v-if="pregunta_view == 'create'" class="modal-title mb-0 h6">
                                    {{ __('Agregar Pregunta') }}</p>
                                <p v-if="pregunta_view == 'edit'" class="modal-title mb-0 h6">
                                    {{ __('Editar Pregunta') }}</p>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <section class="row">
                                    <aside class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger" style="font-size: 12px;"
                                                v-show="errors.has('question')">* @{{ errors.first('question') }}</span>
                                        </div>
                                    </aside>
                                    <aside class="col-md-12"
                                        v-if="CurrentTema.length > 0 && CurrentTema[0].tipo == 'selectMultiple'">
                                        <div class="input-group mb-3">
                                            <input type="text" v-model="adding_option"
                                                class="form-control single-input-form"
                                            ...
                                            <div class="input-group-append">
                                                <button :disabled="adding_option == ''"
                                                    ...
                                                    @click="agregarOpcion()" type="button">Agregar Opción</button>
                                            </div>
                                        </div>
                                    </aside>
                                    <aside class="col-md-12"
                            ...
                            <div class="modal-footer">
                                <button v-if="pregunta_view == 'create'" type="button"
                                    @click="validate(agregarPregunta)"
                                    class="btn btn-info btn-sm rounded-0">{{ __('Agregar') }}</button>
                                <button v-if="pregunta_view == 'edit'" type="button"
                                    @click="validate(updatePregunta)"
                                    class="btn btn-warning btn-sm rounded-0">{{ __('Actualizar') }}</button>
                                <button type="button" class="btn btn-danger btn-sm rounded-0" @click="closeModal()"
                                    data-dismiss="modal">{{ __('Cerrar') }}</button>
                            </div>
    ...
    @section('scripts')
        ...
        <script type="text/javascript" src="{{ asset('/js/custom/examenes/editar.js') }}"></script>
    @endsection
</x-app-layout>
